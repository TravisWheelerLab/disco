...
class BaseModel(pl.LightningModule):
    ...
    def _setup_layers(self):
        raise NotImplementedError("Classes that inherit from BaseModel"
    ...
    def train_dataloader(self):
        train_dataset = SpectrogramDatasetMultiLabel(self.train_files,
                                                     apply_log=self.log,
    ...
    def val_dataloader(self):
        val_dataset = SpectrogramDatasetMultiLabel(self.val_files,
                                                   apply_log=self.log,
                                                   vertical_trim=self.vertical_trim,
