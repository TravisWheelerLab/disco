...
if __name__ == "__main__":
    ...
    ensemble_directories = glob(fig_util.root + "*ensemble*")
    # add more:
    more_random_ensembles = glob(
        "/Users/wheelerlab/more/more_ensembles/random_init/UNet1D/*ensemble*"
    )
    more_bootstrap_ensembles = glob(
        "/Users/wheelerlab/more/more_ensembles/bootstrap/UNet1D/*ensemble*"
    )
