...
csv_root="/xdisk/twheeler/colligan/disco_hmm_accuracy_csvs/"
data_root="/xdisk/twheeler/colligan/hmm_ablation/disco_accuracy/"
for method in "bootstrap" "random_init"
do
for ensemble_member in 10 2 30
do
  ...
  do
    ...
    python disco/hmm_accuracy_metrics.py $infer_data_root $out_path $ensemble_member $method
  done
done
done
