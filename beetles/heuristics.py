...
def remove_a_chirps_in_between_b_chirps(predictions, iqr, name_to_class_code, return_preds=True):
    ...
    for i in range(1, len(transitions) - 1):
        ...
        if current_class == name_to_class_code['A'] and transitions[i-1]['class'] == name_to_class_code['B'] and transitions[i+1]['class'] == name_to_class_code['B']:
            ...
            predictions[current_dct['start']:current_dct['end']] = name_to_class_code['BACKGROUND']
