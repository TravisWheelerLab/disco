...
from disco_sound.plots.figure_utils import root

western_meadowlark, _ = torchaudio.load(
    os.path.join(root, "example_spectrograms", "western_meadowlark.wav")
)
hello = os.path.join(root, "example_spectrograms", "hello.pkl")
beetles, _ = torchaudio.load(os.path.join(root, "example_spectrograms", "example.wav"))
