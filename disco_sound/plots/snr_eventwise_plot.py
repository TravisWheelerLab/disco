...
from disco_sound.plots.accuracy_metrics import (
    eventwise_metrics,
    load_accuracy_metric_data,
)
...
if __name__ == "__main__":
    ...
    root = os.path.join(fig_util.root, "snr_plots")
    # compare the different ensembles.

    ensemble_to_cmat = {}

    for ensemble_directory in glob(os.path.join(root, "*ensemble*")):
        conf_matrix = None
